...
static void set_symbol_map(Symbol &s, void *ptr_value) {
    std::strncpy(s.type, "map", sizeof(s.type) - 1);
    s.type[sizeof(s.type) - 1] = '\0';
    s.num_value = 0;
    s.bool_value = 0;
    s.str_value[0] = '\0';
...
static void set_symbol_set(Symbol &s, void *ptr_value) {
    std::strncpy(s.type, "set", sizeof(s.type) - 1);
    s.type[sizeof(s.type) - 1] = '\0';
    s.num_value = 0;
    s.bool_value = 0;
    s.str_value[0] = '\0';
